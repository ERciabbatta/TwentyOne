...
class StreakResetLogic {
  ...
  ///
  /// [now] istante di valutazione (atteso intorno alle 02:00).
  ...
  static bool shouldResetStreak({
    ...
    // Se il check-in del giorno di riferimento è già stato registrato,
    // non bisogna azzerare nulla (guard condition).
    if (lastActiveDateKey == giornoAtteso) return false;
